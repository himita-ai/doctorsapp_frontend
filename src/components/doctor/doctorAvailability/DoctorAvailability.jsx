...
const DoctorAvailability = () => {
  ...
  const submitData = async(e)=> {
    try {
      ...
      const response = await axios.post("mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/submitdoctoravailability",availabilityData,{headers: {'Authorization': `${token}`}});
