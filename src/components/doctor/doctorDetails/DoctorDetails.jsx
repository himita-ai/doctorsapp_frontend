...
const DoctorDetails = () => {
    ...
    return (
        <div className='doctordetails'>
            <div className='doctorimage'><img className='doctorprofileimage' src={`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/`+doctorDetails.profile_image} alt='doctor'></img></div>
