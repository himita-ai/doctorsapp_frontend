...
const PrescriptionManager = () => {
  ...
  const submitPrescriptions = async () => {
    ...
    try {
      await axios.post("mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/addDetailsToPatient", { bookingId:id, prescription:prescriptions }, { headers: { 'Authorization': `${token}` } });
