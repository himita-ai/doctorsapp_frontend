...
const AdminNotifications = () => {
    ...
    const getRequests = async () => {
        try {
            ...
            const response = await axios.get(`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/getApprovalRequestList`, {
                headers: {
                    'Authorization': `${token}`
                }
            });
