...
const AdminDetails = () => {
    ...
    return (
        <div className='admindetails'>
            <div className='adminimage'><img className='adminprofileimage' src={`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/` + adminDetails.profile_image} alt='admin'></img></div>
