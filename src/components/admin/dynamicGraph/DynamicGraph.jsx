...
const DynamicGraph = () => {
    ...
    const doctorAndPatientCount = async () => {
        ...
        try {
            const response = await axios.get(`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/getTotalPatientByDoctor`, { headers: { 'Authorization': `${token}` } });
    ...
    const dateAndPatientCount = async () => {
        const token = localStorage.getItem('authToken');
        try {
            const response = await axios.get(`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/getTotalPAtientByDate`, { headers: { 'Authorization': `${token}` } });
