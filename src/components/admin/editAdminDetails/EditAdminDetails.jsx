...
const EditAdminDetails = () => {
    ...
    return (
        <div className='editadmindetails'>
            <div className='editadminimage'><img className='editadminprofileimage' src={`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/` + adminDetails.profile_image} alt='admin'></img></div>
