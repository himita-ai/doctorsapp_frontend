...
const AddNews = () => {
  ...
  const submitNews = ()=> {
    ...
    axios.post("mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/newsentry",newsData, {
      headers: {
        'Authorization': `${token}`
      }
    })
