...
const Register = () => {
    ...
    const submitData = async (e) => {
        axios.post("mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/register", registrationData)
            .then((response) => {
                navigate('/login');
            })
            .catch((error) => {
