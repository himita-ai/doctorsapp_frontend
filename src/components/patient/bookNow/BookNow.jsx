...
const BookNow = ({ date, id, email }) => {
    ...
    const getDoctorsDetails = async () => {
        try {
            const dataset = await axios.get(`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/getdoctoravailability`, { params: { id: id } });
    ...
    const getAlreadyBookedData = async () => {
        try {
            const dataset = await axios.get(`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/getalreadybookedslots`, { params: { id: id } });
            console.log(dataset);
    ...
    const bookSlot = async () => {
        ...
        try {
            ...
            await axios.post(`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/submitbookings`, bookingData, { headers: { 'Authorization': `${token}` } });
            alert('slot booked');
        } catch (error) {
            alert(error);
        }
