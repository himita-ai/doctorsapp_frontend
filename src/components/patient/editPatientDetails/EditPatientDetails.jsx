...
const EditPatientDetails = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/getuserdetails`, {
                headers: {
                    'Authorization': `${token}`
                }
            });
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const token = localStorage.getItem('authToken');
            const response = await axios.patch(`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/updateuserdetails`, profileData, {
                headers: {
                    'Authorization': `${token}`
                }
            });
    ...
    return (
        <div className='editpatientdetails'>
            <div className='editpatientimage'><img className='editpatientprofileimage' src={`mongodb+srv://himitagangwani:011HAEgwIr5E51wJ@cluster0.foqigmu.mongodb.net/doctorsapp?retryWrites=true&w=majority&appName=Cluster0/` + patientDetails.profile_image} alt='patient'></img></div>
